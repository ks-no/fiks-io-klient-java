...
import no.ks.fiks.svarinn.client.konfigurasjon.IdPortenKonfigurasjon;
import no.ks.fiks.svarinn.client.konfigurasjon.KontoKonfigurasjon;
...
class SvarInnKlientFactoryTest {
    ...
    void build() {
        ...
        final SvarInnKonfigurasjon svarInnKonfigurasjon = SvarInnKonfigurasjon.builder()
                                                                              ...
                                                                              .build();
        assertThrows(RuntimeException.class, () -> SvarInnKlientFactory.build(svarInnKonfigurasjon));

    }

    private static PrivateKey generatePrivateKey() {
        try (final InputStream keyStream = SvarInnKlientFactoryTest.class.getResourceAsStream("/alice.key");
    ...
    private static KeyStore readAliceVirksomhetssertifikat() {
        try (final InputStream inputStream = SvarInnKlientFactoryTest.class.getResourceAsStream("/" + "alice-virksomhetssertifikat.p12")) {
