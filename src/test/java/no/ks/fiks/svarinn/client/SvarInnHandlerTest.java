...
class SvarInnHandlerTest {
    ...
    private SvarInnHandler svarInnHandler;

    @BeforeEach
    void setUp() {
        this.svarInnHandler = new SvarInnHandler(kontoId, utsendingKlient, katalogHandler, asicHandler);
    }
    ...
    class Send {
        ...
        void sendEmptyPayload() {
            ...
            final SendtMelding sendtMelding = svarInnHandler.send(meldingRequest, Collections.emptyList());
            assertAll(
        ...
        void harPayload() {
            ...
            final SendtMelding sendtMelding = svarInnHandler.send(meldingRequest,
    ...
    class BuildKvitteringSender {
        ...
        void buildKvitteringSender() {
            ...
            final SvarSender svarSender = svarInnHandler.buildKvitteringSender(() -> {
            }, mottattMelding);
